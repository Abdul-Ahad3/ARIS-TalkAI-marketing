...
export const journeyMoments: JourneyMoment[] = [
  ...
  { time: "14:00", mode: "cloud&api", title: "An inter-regional team needs better, seamless communication", description: "Easy integration of the ARIS API to your meeting app" },
